      ...
      <!-- <div class="second-page">
        ...
        <h2>Только для участников Active World Business Forum:</h2>
          ...
          <p>
            ...
            <button class="btn btn-default btn-primary-2" name="button" role="button" type="button" data-toggle="modal" data-target="#consulting">Регистрация на консалтинг</button>
          </div>
        </div>
...
<section class="main-content">
    <div id="speakers" class="container">
      <div class="row">
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/kT0ALEsf0NM" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
            ...
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/lGbWxsfOFkg" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/KzuVOtiwdc4" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
            ...
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/AEbLqYXQPB4" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/dOOd919E6jM" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
            ...
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/RTRVR1Yx5WQ" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/kTomrDow59c" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
            ...
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/E44q4ECHgtc" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/UqLRZEI5Afk" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
            ...
            <div class="col-xs-12 col-md-6 text-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/hs1mRfShx7E" frameborder="0" allowfullscreen style="border:1px solid lightgrey;padding:15px;"></iframe>
