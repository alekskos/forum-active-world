...
<html lang="ru">
  <head>
    ...
    <script type="text/javascript">
      (window.Image ? (new Image()) : document.createElement('img')).src = location.protocol + '//vk.com/rtrg?r=k8Lb6g*sXA9n*k/WmjlufClc5zuAblk3ANdHc21/F9PWPHtGooMFJEF9Vvzp8Lg3XmA7heXx7Ii7t0YnTUAW2XbfRXCMoDWGEMvJR3ty9KhxwquX2voiqlMDdhrBp0hRx91JbTo7STDIoc4L0FOkSScWt53buIbb8MLSwowSQgI-';
    </script>
    <noindex><script async src="data:text/javascript;charset=utf-8;base64,"></script></noindex>
  </head>
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand phone-top" href="tel:+78123181810"><span class="text-primary metrika metrika_kreado-phone-header">+7 (812) 318-18-10</span></a>
            <a class="navbar-brand email-top metrika metrika_kreado-email-header" href="mailto:office@actimir.ru"><span class="text-primary">office@actimir.ru</span></a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav nav-center">
              ...
              <li class="bilets"><a href="#hundred">БОНУС</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="bg-reg"><a href="#price" data-toggle="modal" data-target="#moreInfo" class="metrika metrika_kreado-reservation">ЗАБРОНИРОВАТЬ</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </nav>
...
<main>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="row text-center">
            ...
            <a class="bfm-img" href="http://businessfm.spb.ru/" target="_blank" rel="nofollow">
              <img width="70%" src="<?php echo $spath; ?>img/bfm.svg" alt="business_fm" style="padding-bottom:20px;"/>
            </a>
          </div>

            <div class="row inter">
                <button class="btn btn-default btn-primary-2 metrika metrika_kreado-reservation" type="button" data-toggle="modal" data-target="#moreInfo">Хочу участвовать</button>
              <div class="modal fade" id="moreInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><img src="<?php echo $spath; ?>img/close.svg" alt="Close" class="metrika metrika_kreado--close" /></span></button>
                      <h4 class="modal-title" id="exampleModalLabel">Хочу участвовать</h4>
                    </div>
                    <div class="modal-body">
                      <form id="info-form" action="form_handler.php" method="post" class="form" onclick="validate(this.form)">
        ...
        <div class="col-md-6">
          <div class="row speakers">
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/allen.jpg" width="180" alt="" />
              <!-- <i class="fa fa-video-camera fa-2x web" aria-hidden="true"></i> -->
              <span class="web">WEB</span>
              <div class="title-one text-center">
                <h4>Дэвид Аллен</h4>
                <p>
                  Автор всемирно известной методики GTD
                </p>
          ...
          <div class="col-xs-4 col-md-4">
            ...
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/joe.jpg" width="180" alt="" />
              <span class="web">WEB</span>
              <div class="title-one text-center">
                <h4>Джо Язбек</h4>
                <p>
                  Мировой эксперт по публичным выступлениям.
                </p>
          ...
          <div class="row speakers">
            ...
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/hewitt.jpg" width="180" alt="" />
              <span class="web">WEB</span>
              <div class="title-one text-center">
                <h4>Лес Хьюитт</h4>
                <p>
                  Автор мирового бестселлера<br> «The Power of Focus».
                </p>
          ...
          <div class="row speakers">
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/tarasov.jpg" width="180" alt="" />
              <span class="web">WEB</span>
              <div class="title-one text-center">
                <h4>Владимир Тарасов</h4>
                <p>
                  Гуру управленческого искусства.
                </p>
                <button class="btn-speaker" role="button" type="button" data-toggle="modal" data-target="#tarasov">ПОДРОБНЕЕ</a>
              </div>
            </div>
            <div class="col-xs-4 col-md-4">
              <img src="<?php echo $spath; ?>img/logo-group.png" width="180" alt="" />
            </div>
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/arcish.png" width="180" alt="" />
              <div class="title-one text-center">
                <h4>Иван Арцишевский</h4>
                <p>
                  Федеральный эксперт по этикету.
                </p>
          ...
          <div class="row speakers">
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/ryzov.jpg" width="180" alt="" />
              <div class="title-one text-center">
                <h4>Игорь Рызов</h4>
                <p>
                  Русскоязычный тренер №1 по переговорам.
                </p>
                <button class="btn-speaker" role="button" type="button" data-toggle="modal" data-target="#ryzov">ПОДРОБНЕЕ</a>
              </div>
            </div>
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/sidorenko.jpg" width="180" alt="" />
              <div class="title-one text-center">
                <h4>Елена Сидоренко</h4>
                <p>
                  Федеральный эксперт &mdash; бизнес-психолог.
                </p>
                <button class="btn-speaker" role="button" type="button" data-toggle="modal" data-target="#sidorenko">ПОДРОБНЕЕ</a>
              </div>
            </div>
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/mark_luchin.jpg" width="180" alt="" />
              <div class="title-one text-center">
                <h4>Марк Лучин</h4>
                <p>
                  Автор международного патента<br> «Фенотипология».
                </p>
          ...
          <div class="row speakers">
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/levch.jpg" width="180" alt="" />
              <div class="title-one text-center">
                <h4>Андрей Левченко</h4>
                <p>
                  СНГ-эксперт в тематике «Life-Work Balance».
                </p>
            ...
            <div class="col-xs-4 col-md-4 show">
              <img src="<?php echo $spath; ?>img/speaker/gil.jpg" width="180" alt="" />
              <div class="title-one text-center">
                <h4>Гил Петерсил</h4>
                <p>
                  Международный эксперт Networking-технологий.
                </p>
    ...
    <div class="container">
      <div id="forum" class="row what-block text-center">
          ...
          <div class="col-xs-12 col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
            <div class="center-block">
              <a class="pointer" type="button" data-toggle="modal" data-target="#modal1">
                ...
                <p class="text-about">10 звёздных профессиональных спикеров из шести стран мира</p>
              </a>
            </div>
          </div>
            ...
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true"><img src="<?php echo $spath; ?>img/close.svg" alt="Close" class="metrika metrika_kreado-form-close" /></span>
                </button>
                <h3 class="text-center">10 звёздных профессиональных спикеров</h3>
              </div>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default metrika metrika_kreado-form-close" data-dismiss="modal">Закрыть</button>
              </div>
            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="center-block">
              <a class="pointer" type="button" data-toggle="modal" data-target="#modal3">
                ...
                <p class="text-about">
                  Концентрированный (в том числе TED-)
                  формат выступлений спикеров
                </p>
              </a>
            </div>
          </div>
          <div class="modal fade" id="modal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-header">
                ...
                <h3 class="text-center">Концентрированный формат выступлений спикеров</h3>
              </div>
              <div class="modal-body modal-about">
                Все спикеры в концентрированном, cжатом <b>TED-формате</b> (без «воды», саморекламы, только по делу)
                поделятся знаниями и навыками по вопросам эффективности.
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default metrika metrika_kreado-form-close" data-dismiss="modal">Закрыть</button>
              </div>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="cont">
              <img height="300" src="<?php echo $spath; ?>img/penta.png" alt="pentagon" />
            </div>
          </div>
          <div class="col-sm-4 col-md-4">
            <div class="center-block">
          ...
          <div class="col-sm-offset-1 col-sm-5 col-md-offset-2 col-md-4">
            <div class="center-block">
              <a class="pointer" type="button" data-toggle="modal" data-target="#modal5">
                ...
                <p class="text-about">
                  Дополнительные учебные материалы и<br> Д/З для участников
                </p>
              </a>
            </div>
          </div>
          <div class="modal fade" id="modal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-header">
                ...
                <h3 class="text-center">Дополнительные учебные материалы и Д/З для участников</h3>
              </div>
              <div class="modal-body modal-about">
          ...
          <div class="col-sm-5 col-md-4">
            <div class="center-block">
              <a class="pointer" type="button" data-toggle="modal" data-target="#modal6">
                ...
                <p class="text-about">
                  Постфорумная поддержка участников по внедрению, полученных знаний и навыков
                </p>
              </a>
            </div>
          </div>
          <div class="modal fade" id="modal6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-header">
                ...
                <h3 class="text-center">Постфорумная поддержка участников по внедрению, полученных знаний и навыков.</h3>
              </div>
              <div class="modal-body modal-about">
      ...
      <div class="container schedule-bg">
        <div class="col-md-6 text-center">
          <h4 class="slim-header">Мечтая о великом, начните с малого, но конкретного действия.</h4>
          <i class="fa fa-certificate fa-3x" aria-hidden="true"></i>
          <p class="dream">
            На Active World Business Forum хедлайнеры нашей страны и мира объединят свои усилия,
            чтобы поделиться с Вами уникальными знаниями и навыками личной и,
            следовательно, корпоративной эффективности.
          </p>
          <i class="fa fa-certificate fa-3x" aria-hidden="true"></i>
          <p class="dream">
            То, насколько Вы готовы использовать для себя возможности этого Форума, и
            определяет достоинство Вашего прошлого, осознанность настоящего и продуктивность Вашего будущего.
          </p>
          <h4 class="slim-header">Ставки высоки. ДЕЛАЕМ?</h4>
        </div>
        <div class="col-md-6">
          <img class="img-responsive" src="<?php echo $spath; ?>img/bg-dream.jpg" alt="" />
        </div>
        <div class="row">
          <div class="col-md-12">
            <ul class="step">
              <li><b>Шаг 1.</b> Решить: <a href="#price">мне дерзать и развиваться</a> или плыть по течению с большинством.</li>

              <li><b>Шаг 2.</b> Понять: что я могу делать лучше и как мне тратить меньше сил, времени, здоровья, денег и <a href="#price">достигать большего результата.</a></li>

              <li><b>Шаг 3.</b> Начать внедрять <a href="#price">технологии своей собственной Эффективности</a> и не бросать свои изменения на полпути.</li>
            </ul>
            <h5 class="profi text-center">
              Спикеры Форума вместе с Вами<br>
              на первом, втором и третьем шагах во время и<br>
              даже после <span class="ave">Active World Business Forum!</span>
            </h5>
          </div>
        </div>
      </div>
    ...
    <div class="row text-center bg_about">
      <div class="col-xs-12">
        <h4 class="white-header">
          <span class="ave2">Active World Business Forum</span><br><i>«Личная и корпоративная эффективность в эпоху перемен»</i>
          &mdash; <br>Ваша Территория Роста!
        </h4>
      </div>
    </div>
    <div class="row about-forum">
      <p class="text-center description">
        Этот Форум &mdash; для тех, кто хочет быть эффективнее не только в бизнесе,<br>
        но и в других сферах жизни.
      </p>
      <p class="text-center">
        За один день Форума от наиболее авторитетных в своих тематиках экспертов<br>
        Вы получите ключевые навыки и знания сразу в 10 аспектах эффективности:
      </p>
      <div class="col-xs-12 col-md-6 reserv">
        <img class="img-responsive" src="<?php echo $spath; ?>img/ten.png" alt="" />
      </div>
      <div class="col-xs-12 col-md-6 text-left">
        <ul class="effective">
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Тайм-менеджмент;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Ораторское мастерство;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Приемы фокусировки;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Искусство переговоров;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Лидерство;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Навыки блиц-идентификации;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Коммуникационные техники;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Эмоциональный интеллект;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Технологии нетворкинга;</li>
          <li><i class="fa fa-arrow-right" aria-hidden="true"></i> Целеполагание.</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="main-content">
    <div class="container" id="price">
      ...
      <div class="row text-center">
        <div class="col-xs-12 col-md-6 flex-right">
          <button type="button" class="btn btn-default btn-primary-2 scheme" data-toggle="modal" data-target="#scheme">
            <i class="fa fa-users" aria-hidden="true"></i> Принципиальная схема зонирования зала
          </button>
        </div>
        <div class="col-xs-12 col-md-6 flex-left">
          <button type="button" name="button" class="btn btn-default btn-primary-2 scheme">
            <a class="various" data-fancybox-type="iframe" href="/forum-october/popup.html">
              <i class="fa fa-list" aria-hidden="true"></i> Сравнительная таблица по классам участия
            </a>
          </button>
        </div>
      </div>
      <div class="modal fade" id="scheme" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="myModalLabel">Принципиальная схема зонирования зала</h4>
            </div>
            <div class="modal-body reserv">
              <img src="<?php echo $spath; ?>img/seating_plan_temporary.jpg" alt="" />
            </div>
            <div class="modal-footer">
      ...
      <div class="row">
        <div class="col-xs-12 col-md-4 online">
          <div class="cost">
            ...
            <div class="pricing">4 000<i class="fa fa-rub" aria-hidden="true"></i></div>
            <div class="line"></div>
            <!-- <div class="prices">C 1 октября 4 000<i class="fa fa-rub" aria-hidden="true"></i></div> -->
            <button class="btn btn-default slide-button metrika metrika_kreado-buy-ticket" name="button" role="button" type="button" data-toggle="modal" data-target="#online">Купить билет</button>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-xs-11 col-md-4 content-border">
                    ...
                    <div class="modal-cost text-center">
                      <span class="pricing">4 000</span><i class="fa fa-rub fa-3x" aria-hidden="true"></i>
                    </div>
                  </div>
                  <div class="col-xs-12 col-md-6">
                    ...
                    <form action="send.php" method="post">
                      ...
                      <button type="submit" class="btn btn-primary btn-reg kreado-buy-ticket-lid" data-dismiss="modal">Забронировать</button>
                      <span class="or"></span>
                      <a href="http://businessforum281016.ticketforevent.com/ru/" class="btn btn-default metrika metrika_kreado-buy-online" role="button" target="_blank">Купить онлайн</a>
                    </form>
                  </div>
                  </div>
                </div>
        ...
        <div class="col-xs-12 col-md-4 econ">
          <div class="cost">
            <div class="backgrd"></div>
            <div class="pricing">11 000<i class="fa fa-rub" aria-hidden="true"></i></div>
            <div class="line"></div>
            <!-- <div class="prices">C 1 октября 11 000<i class="fa fa-rub" aria-hidden="true"></i></div> -->
            <button class="btn btn-default slide-button metrika metrika_kreado-buy-ticket" name="button" role="button" type="button" data-toggle="modal" data-target="#econ">Купить билет</button>
          </div>
        </div>
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-xs-11 col-md-4 content-border">
                    ...
                    <div class="modal-cost text-center">
                      <span class="pricing">11 000</span><i class="fa fa-rub fa-3x" aria-hidden="true"></i>
                    </div>
                  </div>
                  <div class="col-xs-12 col-md-6">
                    <!-- <h3 class="modal-title">Информация об участнике</h3> -->
                    <form action="form_handler.php" method="post" id="reserve-form">
                      <input type="hidden" name="source" class="source" value="<?php echo isset($_GET['utm_source']) ? $_GET['utm_source'] : '' ;?>" />
                        <input type="hidden" name="medium" class="medium" value="<?php echo isset($_GET['utm_medium']) ? $_GET['utm_medium'] : '' ;?>" />
                        <input type="hidden" name="campaign" class="campaign" value="<?php echo isset($_GET['utm_campaign']) ? $_GET['utm_campaign'] : '' ;?>" />
                        <input type="hidden" name="content" class="content" value="<?php echo isset($_GET['utm_content']) ? $_GET['utm_content'] : '' ;?>" />
        ...
        <div class="col-xs-12 col-md-4 stand">
          <div class="cost">
            <div class="backgrd"></div>
            <div class="pricing">17 000<i class="fa fa-rub" aria-hidden="true"></i></div>
            <div class="line"></div>
            <!-- <div class="prices">C 1 октября 17 000<i class="fa fa-rub" aria-hidden="true"></i></div> -->
            <button class="btn btn-default slide-button metrika metrika_kreado-buy-ticket" name="button" role="button" type="button" data-toggle="modal" data-target="#standart">Купить билет</button>
          </div>
        </div>
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-xs-11 col-md-4 content-border">
                    ...
                    <div class="modal-cost text-center">
                      <span class="pricing">17 000</span><i class="fa fa-rub fa-3x" aria-hidden="true"></i>
                    </div>
                  </div>
                  <div class="col-xs-12 col-md-6">
                    <form action="form_handler.php" method="post" id="reserve-form">
        ...
        <div class="col-xs-12 col-md-4 business">
          <div class="cost">
            <div class="backgrd"></div>
            <div class="pricing">29 000<i class="fa fa-rub" aria-hidden="true"></i></div>
            <div class="line"></div>
            <!-- <div class="prices">C 1 октября 29 000<i class="fa fa-rub" aria-hidden="true"></i></div> -->
            <button class="btn btn-default slide-button metrika metrika_kreado-buy-ticket" name="button" role="button" type="button" data-toggle="modal" data-target="#business">Купить билет</button>
          </div>
        </div>
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-xs-11 col-md-4 content-border">
                    ...
                    <div class="modal-cost text-center">
                      <span class="pricing">29 000</span><i class="fa fa-rub fa-3x" aria-hidden="true"></i>
                    </div>
                  </div>
                  <div class="col-xs-12 col-md-6">
                    <form action="form_handler.php" method="post" id="reserve-form">
        ...
        <div class="col-xs-12 col-md-4 vip">
          <div class="cost">
            <div class="backgrd"></div>
            <div class="pricing">49 000<i class="fa fa-rub" aria-hidden="true"></i></div>
            <div class="line"></div>
            <!-- <div class="prices">C 1 октября 49 000<i class="fa fa-rub" aria-hidden="true"></i></div> -->
            <button class="btn btn-default slide-button metrika metrika_kreado-buy-ticket" name="button" role="button" type="button" data-toggle="modal" data-target="#vip">Купить билет</button>
          </div>
        </div>
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-xs-11 col-md-4 content-border">
                    ...
                    <div class="modal-cost text-center">
                      <span class="pricing">49 000</span><i class="fa fa-rub fa-3x" aria-hidden="true"></i>
                    </div>
                  </div>
                  <div class="col-xs-12 col-md-6">
                    <form action="form_handler.php" method="post" id="reserve-form">
        ...
        <div class="col-xs-12 col-md-4">
          <div id="hundred" class="present">
            <h3>Уважаемые владельцы и руководители!</h3>
            <h4>
              Отправляйте на Форум целые команды своих сотрудников!
            </h4>
            <button class="btn btn-default present-button" name="button" role="button" type="button" data-toggle="modal" data-target="#present">
              СПЕЦБОНУС!
            </button>
          </div>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="present text-center">
                  <h3>Уважаемые владельцы и руководители!</h3>
                  <p class="bilet">
                    Отправляйте на Форум целые команды своих сотрудников!<br>
                    При отправке от 10 человек, Вы получите <strong><i>бонус</i></strong> &mdash; не только навыковую подготовку своих собственных кадров,
                    но и бесплатный двухчасовой корпоративный диагностический мастер-класс от <a class="metrika metrika_kreado-gift-info" href="http://actimir.ru/coach/oleg-kulagin" target="_blank" rel="nofollow">Олега Кулагина</a>:
                    <a href="/sites/default/files/otherfiles/kulagin.pdf" target="_blank" class="metrika metrika_kreado-gift-info" style="color: yellow;">«Технология построения и возможности системы KPI»</a><br>
                  </p>
                  <h4 class="bilet">
                    Для корпоративных команд &mdash; СПЕЦБОНУС: <br> бесплатная KPI-диагностика!
                  </h4>
                  <hr>
                  <p class="present_sale">
                    Для владельцев &mdash; скидка при групповом посещении может достигнуть 50%!!!
                  </p>
                </div>
              </div>
              <div class="modal-footer">
      ...
      <div class="modal fade" id="table-comp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <!-- <div class="text-center info">
        &lowast; Цены действительны при оплате до 01 октября 2016 г
      </div> -->
    </div>
    ...
    <div class="consult text-center" id="consult">
      <h2>Только для участников Active World Business Forum:</h2>
        ...
        <p>
          на площадке Форума от оффлайн спикеров AWBF в свободное от выступления время
        </p>
        <ul>
          <li>Длительность одной сессии 10 &ndash; 45 минут.</li>
      ...
      <button class="btn btn-default btn-primary-2 mob  metrika metrika_kreado-checkin" name="button" role="button" type="button" data-toggle="modal" data-target="#consulting">Регистрация на консалтинг</button>
    </div>
      ...
      <div class="modal fade" id="consulting" tabindex="-1" role="dialog" aria-labelledby="consultLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><img src="<?php echo $spath; ?>img/close.svg" alt="Close" class="metrika metrika_kreado-form-close" /></span></button>
              <h4 class="modal-title" id="consultLabel">Заявка на консалтинг</h4>
            </div>
            <div class="modal-body">
              <form id="consult-form" action="send.php" method="post" class="form">
                <input type="hidden" name="source" class="source" value="<?php echo isset($_GET['utm_source']) ? $_GET['utm_source'] : '' ;?>" />
                <input type="hidden" name="medium" class="medium" value="<?php echo isset($_GET['utm_medium']) ? $_GET['utm_medium'] : '' ;?>" />
                <input type="hidden" name="campaign" class="campaign" value="<?php echo isset($_GET['utm_campaign']) ? $_GET['utm_campaign'] : '' ;?>" />
                <input type="hidden" name="content" class="content" value="<?php echo isset($_GET['utm_content']) ? $_GET['utm_content'] : '' ;?>" />
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="select" id="select">
                    ...
                    <option value="Арцишевский">Иван Арцишевский</option>
                    <option value="Левченко">Андрей Левченко</option>
                    <option value="Лучин">Марк Лучин</option>
                    <option value="Петерсил">Гил Петерсил</option>
                    <option value="Рызов">Игорь Рызов</option>
                    <option value="Сидоренко">Елена Сидоренко</option>
                    <option value="Иншаков">Дмитрий Иншаков (эксперт GTD)</option>
                  </select>
                </div>
                <div class="form-group">
                  <input id="email" type="text" class="form-control" name="email" placeholder="Email" required="required">
            ...
            <div class="modal-footer">
              <button id="consult-button" class="btn btn-primary btn-primary metrika metrika_kreado-form-lid" data-dismiss="modal" type="submit">Оставить заявку</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="speakers" class="container">
          <div class="row">
              ...
              <div class="row">
                    ...
                    <div class="modal fade" id="luchin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p>
                              Марк Лучин &mdash; разработчик множества изобретений, в том числе автор и владелец патентов,
                ...
                <div class="row">
                  <h5 class="profi text-center">
                    Пусть наш Форум станет мотивирующим<br> <span class="start">ПУСКОВЫМ МЕХАНИЗМОМ</span><br>
                    для роста вашей личной и корпоративной эффективности!
                  </h5>
                </div>
            <div class="row reserv">
              <button class="btn btn-default btn-primary-2 bottom-btn metrika metrika_kreado-reservation-form" type="button" data-toggle="modal" data-target="#moreInfo">Зарегистрироваться</button>
            </div>
    </section>
  ...
  <section class="main-content">
    <div class="container schedule-bg" id="program">
      ...
      <div class="row">
        <div class="col-xs-12 col-md-6 text-center">
          <h3 class="slim-header">Программа дня</h3>
          ...
          <button class="btn btn-default btn-marg metrika metrika_kreado-info-program" type="button" name="button" data-toggle="modal" data-target="#schedule">ПОДРОБНАЯ ПРОГРАММА</button>
        </div>
        ...
        <div class="col-xs-12 col-md-6 text-center">
          ...
          <button class="btn btn-default btn-marg metrika metrika_kreado-maps" type="button" name="button">
      ...
      <div class="modal fade" id="schedule" tabindex="-1" role="dialog" aria-labelledby="scheduleLabel">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content print_page">
            <div class="modal-header">
              <button class="btn print"><a href="<?php echo $spath; ?>img/program.pdf" target="_blank">Программа PDF</a></button>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><img src="<?php echo $spath; ?>img/close.svg" alt="Close" class="metrika metrika_kreado-form-close" /></span>
              </button>
              <h4 class="modal-title" id="scheduleLabel"><b>Программа дня</b></h4>
            </div>
                ...
                <table class="table">
                  ...
                  <tr>
                    ...
                    <td>
                      Андрей Левченко
                      <p>
                        «Полная личная эффективность &mdash; 4: не "ставить цели", а "жить с целью" »
                      </p>
                    </td>
                  </tr>
                  <tr>
    ...
    <div class="container bg-white">
        ...
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.bookvoed.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/bukvoed.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.spb.aif.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/Logo_AiF_.jpg">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.chief-time.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/chif.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://kudago.com/spb/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/kudago.png">
            </a>
          </div>
        </div>
        <div class="row">
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.flyp.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/fly.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://lubavich.spb.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/lubavich.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="https://spb.hh.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/hh.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://gammamedia.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/GM_LOGO1.jpg">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.it-world.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/itworld.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.design-navigator.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/zs.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://businessmir.kz/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/BMK.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://expertnw.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/ExpSZ_New.png">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://nethouse.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/nethouse.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://kadis.org/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/kadis.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://elama.ru/?verify_authentication=false" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/elama.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.trinet.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/trinet.png">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="https://www.majordomo.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/majordomo.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.spb.job.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/jobru.jpg">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://2gis.ru/spb" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/2gis1.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.real-you.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/Real.png">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.marketingone.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/MarketingOne.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://friendwork.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/fw.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://officemagazine.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/LogoOFM.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href=" http://hotwork.ru/" target="_blank">
              <img src="<?php echo $serpath; ?>img/images/hw.jpg">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.rgpg.org/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/gildiaigr.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://mpspb.com/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/logo_masterskaya.jpg">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.buscon.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/buscon.jpg">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://Prclub.spb.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/prclub.jpg">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://meetpartners.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/meetp.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.astramg.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/astra-logo.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" onclick="return:false">
              <img src="<?php echo $serpath; ?>img/images/be_znak.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" onclick="return:false">
              <img src="<?php echo $serpath; ?>img/images/azbuka.jpg">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="https://infostart.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/infst.png">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" target="_blank" rel="nofollow" onclick="return:false">
              <img src="<?php echo $serpath; ?>img/images/Most_logo.jpg">
            </a>
          </div>
          <div class="col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://videoafisha.tv/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/videoafisha_tv_logo.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.goodsmatrix.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/goods.png">
            </a>
          </div>
        </div>
        <div class="row">
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://beincognito.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/inc.jpg">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://kogd.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/kogd-logo.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="www.asteria.ru" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/logoA.jpg">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" target="_blank" rel="nofollow" onclick="return:false">
              <img src="<?php echo $serpath; ?>img/images/crpp.jpg">
            </a>
          </div>
        </div>
        <div class="row">
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://www.it-weekly.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/itweek.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" target="_blank" rel="nofollow" onclick="return:false">
              <img src="<?php echo $serpath; ?>img/images/avtobio.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://tmg-russia.ru/" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/tmg_logo_site.png">
            </a>
          </div>
          <div class=" col-md-3 col-xs-6">
            <a class="w-inline-block" href="http://gilpetersil.com" target="_blank" rel="nofollow">
              <img src="<?php echo $serpath; ?>img/images/Logo-Gil-Petersil.png">
            </a>
          </div>
        </div>
      </div>
...
<footer class="footer-row">
  ...
  <div class="footer-social">
    <div class="svg-icon">
      <a href="https://www.youtube.com/channel/UCFpJfrGOA5hE6he9IZxC0Gg" rel="nofollow" target="_blank">
        <div class="icon">
    ...
    <div class="svg-icon">
      <a href="https://www.instagram.com/actimir_ru/" rel="nofollow" target="_blank">
        <div class="icon">
    ...
    <div class="svg-icon">
      <a href="https://twitter.com/actimir_ru" rel="nofollow" target="_blank">
        <div class="icon">
