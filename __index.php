      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand email-top" href="mailto:office@actimir.ru"><span class="text-primary metrika metrika_kreado-email-header">office@actimir.ru</span></a>
          </div>
      ...
      <!-- <div class="second-page">
        ...
        <h2>Только для участников Active World Business Forum:</h2>
          ...
          <p>
            ...
            <button class="btn btn-default btn-primary-2 metrika metrika_kreado-checkin" name="button" role="button" type="button" data-toggle="modal" data-target="#consulting">Регистрация на консалтинг</button>
          </div>
        </div>
      ...
      <div class="modal fade" id="consulting" tabindex="-1" role="dialog" aria-labelledby="consultLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button id="consult-button" class="btn btn-primary metrika metrika_kreado-form-lid" data-dismiss="modal" type="submit">Оставить заявку</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
          <div id="hundred" class="present">
            ...
            <button class="btn btn-default present-button metrika metrika_kreado-gift" name="button" role="button" type="button" data-toggle="modal" data-target="#present">В подарок 1 билет!</button>
          </div>
        </div>
              ...
              <div class="modal-body">
                <div class="present text-center">
                  ...
                  <p class="bilet">
                    ...
                    <a href="http://www.actimir.ru/event/ggoodbye-marketing-hello-customer" target="_blank" class="metrika metrika_kreado-gift-info">"Goodbuy marketing, hello customer!"</a><br>
                    09 декабря 2016
                  </p>
                  <p class="bilet">
                    Осталось:
  ...
  <section class="main-content">
    <div class="container schedule-bg" id="program">
      ...
      <div class="row">
        <div class="col-xs-12 col-md-6 text-center">
          <h3 class="slim-header"><b>Программа</b></h3>
        ...
        <div class="col-xs-12 col-md-6 text-center">
          ...
          <p class="map">
            ...
            <!-- http://2gis.ru/spb/firm/5348552838482302?utm_medium=widget&utm_campaign=firmsonmap&utm_source=bigMap&queryState=center%2F30.216275%2C59.938859%2Fzoom%2F16 -->
          </p>
          <button class="btn btn-default btn-marg" type="button" name="button">
            <a class="various fancybox.iframe metrika metrika_kreado-maps" href="http://go.2gis.com/63g4t">
              ПОСМОТРЕТЬ НА КАРТЕ
            </a>
          </button>
        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content print_page">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="scheduleLabel">Программа Форума</h4>
            </div>
    ...
    <div class="text-center">
      ...
      <div class="video-content">
        <iframe width="672" height="378" src="https://www.youtube.com/embed/q_9P2_x2wcc" frameborder="0" allowfullscreen></iframe>
      </div>
      </div>
    </div>
</section>
...
<section class="main-content">
            ...
            <div class="col-md-offset-1 col-md-4">
              ...
              <div class="row">
                <div class="col-xs-6 col-md-6">
                  ...
                  <div class="row">
                      ...
                      <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#hewitt">ПОДРОБНЕЕ</a>
                  </div>
                </div>
              ...
              <div class="col-xs-6 col-md-6">
                ...
                <div class="row">
                    ...
                    <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#allen">ПОДРОБНЕЕ</a>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-xs-6 col-md-6">
                ...
                <div class="row">
                    ...
                    <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#tarasov">ПОДРОБНЕЕ</a>
                </div>
              </div>
              ...
              <div class="col-xs-6 col-md-6">
                ...
                <div class="row">
                    ...
                    <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#joe">ПОДРОБНЕЕ</a>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-xs-6 col-md-4">
                  ...
                  <div class="row">
                      ...
                      <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#luchin">ПОДРОБНЕЕ</a>
                  </div>
                </div>
                ...
                <div class="col-xs-6 col-md-4">
                  ...
                  <div class="row">
                      ...
                      <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#ryzov">ПОДРОБНЕЕ</a>
                  </div>
                </div>
                ...
                <div class="col-xs-6 col-md-4 sidorenko">
                  ...
                  <div class="row">
                      ...
                      <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#sidorenko">ПОДРОБНЕЕ</a>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-xs-6 col-md-4">
                  ...
                  <div class="row">
                      ...
                      <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#levchenko">ПОДРОБНЕЕ</a>
                  </div>
                </div>
                ...
                <div class="col-xs-6 col-md-4">
                  ...
                  <div class="row">
                      ...
                      <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#gil">ПОДРОБНЕЕ</a>
                  </div>
                </div>
                ...
                <div class="col-xs-6 col-md-4">
                  ...
                  <div class="row">
                      ...
                      <button class="btn btn-default btn-xs metrika metrika_kreado-info" role="button" type="button" data-toggle="modal" data-target="#arcish">ПОДРОБНЕЕ</a>
                  </div>
                </div>
    ...
    <div class="container bg-white">
        <h3 class="slim-header text-center">Информационные партнеры</h3>
        <div class="row">
